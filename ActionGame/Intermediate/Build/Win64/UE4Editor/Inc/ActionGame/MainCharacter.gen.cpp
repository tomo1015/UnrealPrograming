...
#include "ActionGame/MainCharacter.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	ACTIONGAME_API UClass* Z_Construct_UClass_AMainCharacter();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMainCharacter_Statics::NewProp_CameraBoom_MetaData[] = {
		...
		{ "Category", "Camera" },
		{ "Comment", "//?X?v?????O?A?[???i?J?????\xca\x92u?\xcc\x92??\xdf\x81j\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "MainCharacter.h" },
		{ "ToolTip", "?X?v?????O?A?[???i?J?????\xca\x92u?\xcc\x92??\xdf\x81j" },
	};
#endif
	...
	IMPLEMENT_CLASS(AMainCharacter, 3881416715);
	template<> ACTIONGAME_API UClass* StaticClass<AMainCharacter>()
	{
		return AMainCharacter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMainCharacter(Z_Construct_UClass_AMainCharacter, &AMainCharacter::StaticClass, TEXT("/Script/ActionGame"), TEXT("AMainCharacter"), false, nullptr, nullptr, nullptr);
