...
{
	// If ActionGame is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in ActionGame.Build.cs is not automatically propagated
